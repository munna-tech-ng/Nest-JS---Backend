...
import { isMultipartRequest, getStringValue } from "src/core/utils/multipart.util";
...
export class LocationController {
  ...
  async create(
    ...
    if (!req || !isMultipartRequest(req)) { 
      throw new InvalidMultipartRequestException("Request must be multipart/form-data for file upload");
    }
